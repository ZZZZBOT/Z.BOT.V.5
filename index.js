...
const time2 = moment().tz("Asia/Jakarta").format("HH:mm:ss");
    if (time2 < "24:59:00") {
      var ucapanWaktu = "Êœá´‡ÊŸÊŸá´ Good night";
    }
    if (time2 < "19:00:00") {
      var ucapanWaktu = "Êœá´‡ÊŸÊŸá´ Good eveningðŸŒž";
    }
    if (time2 < "18:00:00") {
      var ucapanWaktu = "Êœá´‡ÊŸÊŸá´ Good afternoonðŸŒ„";
    }
    if (time2 < "15:00:00") {
      var ucapanWaktu = "Êœá´‡ÊŸÊŸá´ Good afternoonâ˜€ï¸";
    }
    if (time2 < "11:00:00") {
      var ucapanWaktu = " Êœá´‡ÊŸÊŸá´ Good morningðŸŒ…";
    }
    if (time2 < "05:00:00") {
      var ucapanWaktu = "Êœá´‡ÊŸÊŸá´ Good nightðŸŒƒ";
    }
 // BATAS \\
menusimpel = false
banChats = false;
...
owner = "94771323434"; 
fakeyoi = "ÍÉªÍá´Í¥á´€Í­êœ±Ì¾Êœá¸» É´á·ŸÉªÍ¤á´…á´œá·¦êœ±Êœá´€áª³ÍÍ›"; 
HunterApi = "Ikyy69", 
xchillds = 'XChillDs' 
hardi = 'hardianto', 
valkey = "rivalgans", 
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`94771323434@s.whatsapp.net`]
...
const daftar1 = `Hi ${pushname} ${ucapanWaktu} \n\nBefore Using the Bot Verify First `
       const daftar2 = '```Click the button below to verify bro or type```\n\nà¶´à·„à¶­ à¶‡à¶­à·’ verify à¶ºà¶± à¶¶à¶§à¶±à¶º à¶šà·Šà¶½à·’à¶šà·Š à¶šà¶» à¶”à¶¶à¶œà·š à¶…à¶‚à¶šà¶º à·€à·™à¶»à·’à·†à¶ºà·’ à¶šà¶» à¶œà¶±à·Šà¶±.à¶±à·à¶­à·’à¶±à¶¸à·Š à¶¶à·œà¶§à·Š à¶”à¶¶à·š à·€à·’à¶¯à·à¶± à¶´à·’à¶½à·’ à¶±à·œà¶´à¶¯à·“\n\ná´˜á´á´¡á´‡Ê€á´… Ê™Ê á´¢ Ê™á´á´›'
       const daftar3 = [
          {
            buttonId: `verify`,
            buttonText: {
...
cmhit.push(command)
    //MESS
    mess = {
      wait: " ```ð™’ð˜¼ð™„ð™ ð˜¼ ð™ˆð™„ð™‰ð™ð™ð™€ ð™• ð˜½ð™Šð™ ð™„ð™Ž ð™ð™„ð™‰ð˜¿```\n\ná´˜á´á´¡á´‡Ê€á´… Ê™Ê á´¢ Ê™á´á´›",
      success: "```ð™Žð™ð˜¾ð˜¾ð™€ð™Žð™Ž``` ã‚·ï¸Ž",
      ...
      only: {
        group: "```ð™Šð™‰ð™‡ð™” ð˜¾ð˜¼ð™ƒð™ ð™Šð™‰ ð™‚ð™ð™Šð™ð™‹```",
      },
    };
...
/*const reply = (teks) => {
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/94771323434?text=hello`}}})
		}*/
      ...
      message: {
        productMessage: {
          product: {
            ...
            description: "ð‘ ðµð‘‚ð‘‡ ð‘‰âž…",
            currencyCode: "USD",
            priceAmount1000: "2000",
            retailerId: "ð‘ ðµð‘‚ð‘‡ ð‘‰âž…",
            productImageCount: 1,
          },
...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/KmeQL6R7mBoDxxoNVMuOef', "groupName": `á´¢á´‡á´… á´¡Êœá´€á´›êœ±á´€á´˜á´˜ Ê™á´á´›`, "footerText": "*Z_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `Xeon`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/94771323434?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nZED. (@nnda.krnwn_) â€¢Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "94771323434@s.whatsapp.net";
...
if (isRegistered) return reply('ð™”ð™Šð™ð™ ð˜¼ð˜¾ð˜¾ð™Šð™ð™‰ð™ ð™„ð™Ž ð™‘ð™€ð™ð™„ð™ð™„ð™€ð˜¿\n\ná´˜á´á´¡á´‡Ê€á´… Ê™Ê á´¢ Ê™á´á´›')
...
*Thank you for registering in the ZBOT Database*
...
*ã€Œ ZBOT ã€*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `</ï¸MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'ð‘ ðµð‘‚ð‘‡ ð‘‰âž…', imageMessage: imageMsg,
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered ZBOT*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =`Hi ${pushname} ðŸ‘‹\n\nIF YOU ARE USING MOD WHATSAPP & BUTTONS DOESNT SHOW, TYPE #allmenu\n\nà¶”à¶¶ à·€à¶§à·Šà·ƒà·à¶´à·Š à¶¸à·œà¶©à·Š à¶·à·à·€à·’à¶­ à¶šà¶»à¶±à·Šà¶±à·š à¶±à¶¸à·Š à¶¶à¶§à·Šà¶±à·Š à¶¸à·™à¶±à·”à·€ à¶±à·œà¶´à·’à¶±à·š\nà¶¸à·œà¶©à·Š à·€à¶§à·Šà·ƒà·à¶´à·Š à¶·à·à·€à·’à¶­ à¶šà¶»à¶±à·Šà¶±à·š à¶±à¶¸à·Š à¶¸à·™à¶±à·”à·€ à·ƒà¶³à·„à· #allmenu à·€à·’à¶¯à·à¶±à¶º à¶·à·à·€à·’à¶­ à¶šà¶»à¶±à·Šà¶±`

               buttons = [{buttonId:`allmenu`, 
               buttonText:{displayText: 'MENUðŸ¼'},type:1},
               {buttonId:`owner`,buttonText:{displayText:'CREATORðŸ¼'},type:1},
               {buttonId:`command`,buttonText:{displayText:'LISTðŸ¼'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `ð‘ ðµð‘‚ð‘‡ ð‘‰âž… ð™’ð™ƒð˜¼ð™ð™Žð˜¼ð™‹ð™‹ ð™ð™Žð™€ð™ ð˜½ð™Šð™
               
 ð™‚ð™ð™Šð™ð™‹ð™Ž    : ${groups.length} 
 ð™‹ ð˜¾ð™ƒð˜¼ð™ð™Ž    : ${privat.length}
 ð˜¼ð™‡ð™‡ ð˜¾ð˜¼ð™ƒð™ð™Ž  : ${totalChat.length}
 ð™Žð™‹ð™€ð™€ð˜¿      : ${latensie.toFixed(4)} _Second_
 ð˜¼ð˜¾ð™ð™„ð™‘ð™€      : ${runtime(process.uptime())}
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       ...
       menu = `
ðŸ¾ ð™ƒð™€ð™‡ð™‡ð™Šð™’â™¥ @${sender.split("@")[0]}

ðŸ¦  ð†ð«ð¨ð®ð© ð‚ð¡ðšð­ð¬ : ${groups.length} 
ðŸ¦  ðð«ð¢ð¯ðšð­ðž ð‚ð¡ðšð­ð¬ : ${privat.length}
ðŸ¦  ð“ð¨ð­ðšð¥ ð‚ð¡ðšð­ð¬ : ${totalChat.length}
ðŸ¦  ð’ð©ðžðžð : ${latensie.toFixed(4)} _Second_
ðŸ¦  ð€ðœð­ð¢ð¯ðž : ${runtime(process.uptime())}
ðŸ¦  ðð¥ðšð­ðŸð¨ð«ð¦ : ${os.platform()}
...
*ð‘ ðµð‘‚ð‘‡ ð‘‰âž…*
 ...
 â¬£ ð˜½ð™Šð™ ð™Šð™’ð™‰ð™€?? ð™ð™€ð˜¼ð™ð™ð™ð™€ð™Ž
> â¬¡ ${prefix}off
> â¬¡ ${prefix}isbaileys
> â¬¡ ${prefix}banchat
> â¬¡ ${prefix}unbanchat
...
*ð™ð™ƒð™„ð™Ž ð™„ð™Ž ð‘ ðµð‘‚ð‘‡ ð‘‰âž… ð™’ð™ƒð˜¼ð™ð™Žð˜¼ð™‹ð™‹ ð™ð™Žð™€ð™ ð˜½ð™Šð™*
`
...
ð’¨ : wa.me/${dtod1.split("@")[0]}
ð’¨ : wa.me/${dtod.split('@')[0]}
ð’¨ : wa.me/${dtod2.split('@')[0]}
 `
...
case 'bugreport':
              ...
              xeon.sendMessage('94771323434@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
break
case 'h':
reply('à¶”à·„à·š à¶ºà¶±à·Šà¶± à¶œà·’à¶º à¶¯à·™à¶±à·Š à¶¶à¶±à·ŠðŸ˜‚.')
break
case 'okeyx':
reply('à¶†à¶¯à¶»à¶ºà·™à¶±à·Š à¶´à·’à¶½à·’à¶œà¶±à·Šà¶±à·€à· à¶”à¶ºà·à·€ à¶¸à·š à¶œà·²à¶´à·Š à¶‘à¶šà¶§â™¥')
break
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('*click on the link below*\nwa.me/94771323434\n\nÍÉªÍá´Í¥á´€Í­êœ±Ì¾Êœá¸» É´á·ŸÉªÍ¤á´…á´œá·¦êœ±Êœá´€áª³ÍÍ›')
break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
               sendKontak(from, `${owner}`, `${fakeyoi}`, 'à·„à·“ à·„à·“ à¶´à·œà¶©à·Šà¶©à¶šà·Š à·€à·à¶© à¶‰à¶­à·’à¶¸à·Š!!')
               await sleep(1000)
               ...
               buttonsMessage = { contentText: `${haibg}`, footerText: `Created By ð™„ð™ˆð˜¼ð™Žð™ƒ `, buttons: buttons, headerType: 1 }
...
ini_list.push({
"displayName": 'ÍÉªÍá´Í¥á´€Í­êœ±Ì¾Êœá¸» É´á·ŸÉªÍ¤á´…á´œá·¦êœ±Êœá´€áª³ÍÍ›',
...
break
case 'downloadmenu':
menu = `ð˜‹ð˜°ð˜¸ð˜¯ð˜­ð˜°ð˜¢ð˜¥ð˜¦ð˜³ ð˜”ð˜¦ð˜¯ð˜¶
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
â”ƒ      ð‘ ðµð‘‚ð‘‡ ð‘‰âž…
â”ƒ
â”ƒð’ˆ”${prefix}ð˜´ð˜°ð˜¯ð˜¨ ð™¡ð™žð™£ð™        
â”ƒ                       
â”ƒð’ˆ”${prefix}ð˜·ð˜ªð˜¥ð˜¦ð˜° ð™¡ð™žð™£ð™        
â”ƒ
â”ƒð’ˆ”${prefix}ð˜´ð˜°ð˜¯ð˜¨ ð™¦ð™ªð™šð™§ð™®
â”ƒ
â”ƒð’ˆ”${prefix}ð™žð™£ð™¨ð™©ð™–ð™œð™§ð™–ð™¢ <ð™ªð™§ð™¡>
â”ƒ
â”ƒð’ˆ”${prefix}ð™©ð™¬ð™žð™©ð™©ð™šð™§ <ð™ªð™§ð™¡>
â”ƒ
â”ƒð’¨á´„Ê€á´‡á´€á´›á´‡á´… Ê™Ê Éªá´á´€êœ±Êœ É´Éªá´…á´œêœ±Êœá´€
â”—â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
`
...
break
case 'groupmenu':
menu = `ð˜Žð˜³ð˜°ð˜¶ð˜± ð˜”ð˜¦ð˜¯ð˜¶ï¸Ž
â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”â”
â”ƒ           ð‘ ðµð‘‚ð‘‡ ð‘‰âž…
â”ƒ
â”ƒ${prefix}grup [3 Button]
â”ƒ
â”ƒ${prefix}promote <reply chat member>
â”ƒ
â”ƒ${prefix}demote <reply chat member>
â”ƒ
â”ƒ${prefix}setdesc
â”ƒ
â”ƒ${prefix}nsfw 1/0
...
â”ƒ${prefix}setname
â”ƒ
â”ƒ${prefix}kick <reply/tag member>
â”ƒ
â”ƒ${prefix}add <reply/tag member>
â”ƒ
â”ƒ${prefix}getbio <reply chat member>
â”ƒ
â”ƒ${prefix}getname <reply chat member>
â”ƒ
â”ƒ${prefix}reminder <msg/2s>
â”ƒ
â”ƒ${prefix}listonline
â”ƒ
â”ƒ${prefix}sider [reply chat bot]
â”ƒ
â”ƒ${prefix}antilink
â”ƒ
â”ƒ${prefix}tod 
â”ƒ
â”ƒ${prefix}tospam amount
â”ƒ
â”ƒ${prefix}autojoin
â”ƒ
â”ƒ${prefix}antivirtex
â”ƒ
â”ƒ${prefix}kickarea
â”ƒ
â”ƒ${prefix}grouplink
â”ƒ
â”ƒ${prefix}resetlink
â”ƒ
â”ƒ${prefix}group [open/close(button)]
â”ƒ
â”ƒð’¨á´„Ê€á´‡á´€á´›á´‡á´… Ê™Ê Éªá´á´€êœ±Êœ É´Éªá´…á´œêœ±Êœá´€
     ...
     break
        ...
        case "broadcast":  
                   if (!isOwner && !mek.key.fromMe) return reply('only owner can use this feature')    
					...
					buff = await xeon.downloadMediaMessage(encmedia)
					for (let _ of anu) {
						xeon.sendMessage(_.jid, buff, image, {quoted:fakestatus ,caption: `ã€Œ  *MY BROADCAST* ã€\n\n${ini_bc}`})
					}
              ...
              .then(async (a) => {
                if (Number(filesize) >= 9999999)
                  return sendMediaURL(
                    from,
                    thumb,
                    `*Z BOT PLAY MUSIC*\n\n*Title* : ${title}\n*Ext* : MP3\n*Filesize* : ${filesizeF}\n*Link* : ${a.data}\n\n*Mp3 à¶‘à¶š à¶¯à·’à¶œ à·€à·à¶©à·“ à¶’ à¶±à·’à·ƒà· à¶‘à¶± à¶‘à¶šà¶šà·Š à¶±à·à·„à·*\n\n*á´˜á´á´¡á´‡Ê€á´… Ê™Ê á´¢ Ê™á´á´›*`
                  );
                const captions = `*Z BOT DOWNLOADING MUSIC*\n\n*Title* : ${title}\n*Ext* : MP3\n*Size* : ${filesizeF}\n*Link* : ${a.data}\n\n*à·ƒà·’à¶‚à¶¯à·”à·€ à¶©à·€à·”à¶±à·Šà¶½à·à¶©à·Š à·€à·™à¶± à¶œà¶¸à¶±à·Š à¶§à·’à¶š à·€à·™à¶½à·à·€à¶šà·Š à¶¯à·™à¶±à·Šà¶±*\n\n*á´˜á´á´¡á´‡Ê€á´… Ê™Ê á´¢ Ê™á´á´›*`;
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write ListðŸ”–`},type:1}]
              ...
              buttonsMessage = {footerText:'ZBOT', imageMessage: imageMsg,
...
sendButMessage(from, tiyo, `Z BOT`, [
            {              
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*ã€Œ MY BROADCASTING ã€*\n\n${body.slice(4)}`})
}
...
case 'writelist':
  ...
  â™¥ ${prefix}write á´¢
  â™¥ ${prefix}folioright á´¢
  â™¥ ${prefix}folioleft á´¢
  â™¥ ${prefix}writedown á´¢
  â™¥ ${prefix}writeleft á´¢`)
  break
case 'folioleft':
if (!c) return reply('Where is the text bro??')
reply(mess.wait)
...
*[Wait] Wait a moment..*`
      ...
      case "yt":
        ...
        var ytresult = "";
        ytresult += "ã€Œ *Z BOT YOUTUBE SEARCH* ã€";
