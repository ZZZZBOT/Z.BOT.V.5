...
xeon.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    const add = function (from, orangnya) {
      xeon.groupAdd(from, orangnya);
        ...
        const grupinv = (teks) => {
        	grup = xeon.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/KmeQL6R7mBoDxxoNVMuOef', "groupName": `ᴢᴇᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ`, "footerText": "*Z_*", "jpegThumbnail": iye, "caption": teks}}, {quoted:mek})
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nZED. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 MY BROADCASTING 」*\n\n${body.slice(4)}`})
}
...
Link : ${get_resultP.url_audio}
    ...
    case 'join':
		            ...
		            hen = args[0]
		            if (!q) return fakestatus('link group')
